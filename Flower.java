...
public class SampleObject extends AnimatedGraphic
{
   ...
   private Graphics win;
	...
	/* Method: SampleObject (constructor) */
   public SampleObject(Graphics inWin)
   {
      super(inWin);
   ...
   {
      if (SOPL_MODE)
         System.out.println("SampleObject.draw()");
